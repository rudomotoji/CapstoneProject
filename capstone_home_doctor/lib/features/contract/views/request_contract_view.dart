                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ButtonHDr(
                        ...
                        label: 'Gửi yêu cầu',
                        onTap: () => BlocProvider(
                          create: (context) => RequestContractBloc(
                              requestContractAPI: requestContractRepository)
                            ..add(RequestContractEventSend(
                                dto: requestContractProvider.getProvider)),
                          child: _doRequestContract(),
                        ),
                      ),
                    ),
                  ],
