...
//   //
//   List<MedicalInstructions> miSelectedList = [];
...
//   List<ListTile> _buildChosingItem(
//       BuildContext context, List<MedicalInstructions2> items) {
//     return items.map((e) {
//       ////
//       miSelectedList = new List<MedicalInstructions>();
//       return ListTile(
//         title: Column(
//           children: <Widget>[
//             //
...
//               child: Row(
//                 children: [
//                   Text('${e.medicalInstructionTypeName}'),
//                   Spacer(),
//                   ButtonHDr(
//                     style: BtnStyle.BUTTON_IMAGE,
//                     image: Image.asset('assets/images/ic-add-more-mi.png'),
//                     onTap: () async {
//                       await _medicalShareBloc.add(MedicalShareEventGet(
//                           patientId: _patientId, medicalInstructionType: 6));
//                       //
//                       _showMedicalShare(
//                           '${e.medicalInstructionTypeName}', miSelectedList);
//                     },
//                   ),
//                 ],
//               ),
//             ),
//             (miSelectedList.length != 0)
//                 ? Container(
//                     width: MediaQuery.of(context).size.width,
//                     height: 200,
//                     child: ListView.builder(
//                       scrollDirection: Axis.horizontal,
//                       itemCount: miSelectedList.length,
...
//                                   miSelectedList[index].images,
//                                   'Phiếu điện tim',
//                                   '${miSelectedList[index].dateCreate}',
//                                   '${miSelectedList[index].diagnose}');
//                             },
//                             child: Stack(
//                               children: [
//                                 SizedBox(
...
//                                   height: 200,
//                                   child: Image.network(
//                                       'http://45.76.186.233:8000/api/v1/Images?pathImage=${miSelectedList[index].images.first}'),
//                                 ),
//                                 Container(
//                                   width: 150,
//                                   height: 200,
...
//                                         .withOpacity(0.3),
//                                     child: Center(
//                                         child: (miSelectedList[index].images ==
//                                                     null ||
//                                                 miSelectedList[index]
//                                                         .images
//                                                         .length <
//                                                     2)
//                                             ? Text('')
//                                             : Text(
//                                                 '${miSelectedList[index].images.length}+',
//                                                 style: TextStyle(
...
//                                           ),
//                                           Text(
//                                             'Ngày tạo: ${miSelectedList[index].dateCreate}',
//                                             style: TextStyle(
//                                                 color: DefaultTheme.WHITE,
//                                                 fontSize: 12),
//                                             maxLines: 1,
...
//                   )
//                 : Container(),
//             //  Container(child: Text('Đây là một list nè')),
//           ],
//         ),
//       );
//     }).toList();
...
//       String nameOfList,
//       List<MedicalInstructions> listItem) {
//     //
//     //   listItem.clear();
//     return items.map((e) {
//       bool checkTemp = false;
...
//                               print(
//                                   'list item child ins selected: ${listItem.toString()}');
//                               print(
...
//         (_listLv3Selected.length != 0)
//             ? Container(child: BlocBuilder<MedInsTypeListBloc, MedInsTypeState>(
//                 builder: (context, state) {
//                   if (state is MedInsTypeStateLoading) {}
//                   if (state is MedInsTypeStateFailure) {
//                     return Container(child: Text('FAILED'));
//                   }
//                   if (state is MedInsTypeRequiredStateSuccess) {
...
//                             borderRadius: BorderRadius.circular(10)),
//                         child: Column(
//                           children: state.list.map((group) {
//                             int index = state.list.indexOf(group);
//                             //

//                             return ExpandableGroup(
//                               headerBackgroundColor:
//                                   DefaultTheme.BLUE_DARK.withOpacity(0.4),
//                               collapsedIcon: SizedBox(
//                                   width: 20,
//                                   height: 20,
//                                   child: Image.asset(
...
//                                   height: 20,
//                                   child:
//                                       Image.asset('assets/images/ic-down.png')),
//                               isExpanded: false,
...
//                               ),
//                               //////
//                               items: _buildChosingItem(
//                                   context, group.medicalInstructions),
//                             );
//                           }).toList(),
//                         ),
//                       );
...
//   _showMedicalShare(String nameOfList, List<MedicalInstructions> listItem) {
//     return showModalBottomSheet(
//         isScrollControlled: true,
//         context: context,
//         backgroundColor: DefaultTheme.TRANSPARENT,
