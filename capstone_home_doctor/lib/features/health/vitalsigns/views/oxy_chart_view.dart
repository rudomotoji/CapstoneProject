...
class OxyChartView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _OxyChartView();
  }
}

class _OxyChartView extends State<OxyChartView> with WidgetsBindingObserver {
                  ...
                  LineChartData(
                    ...
                    lineTouchData: LineTouchData(
                          ...
                          return TouchedSpotIndicatorData(
                            ...
                            FlDotData(
                              ...
                              getDotPainter: (spot, percent, barData, index) =>
                                ...
                                strokeWidth: 1,
                                strokeColor: DefaultTheme.BLACK_BUTTON,
                              ),
                            ),
                          );
                        }).toList();
                      ...
                      touchTooltipData: LineTouchTooltipData(
                        tooltipBgColor: DefaultTheme.GREY_VIEW,
